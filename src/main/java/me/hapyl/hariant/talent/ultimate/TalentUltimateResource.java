...
public enum TalentUltimateResource implements Prefixed, Named, Styled, ComponentLike, RegenerationRule {
    ...
    TalentUltimateResource(@NotNull Component prefix, @NotNull Component name, @NotNull TextColor color) {
        this.prefix = prefix;
        this.name = name;
