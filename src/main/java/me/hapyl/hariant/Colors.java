...
public final class Colors {
    ...
    public static final TextColor DEFAULT_COLOR = TextColor.color(0xB6DBFF);
    public static final TextColor BRAND_COLOR = TextColor.color(0xEF4444);
    public static final TextColor GRAY = TextColor.color(0xBCB7BC);
    ...
    public static final TextColor FORMAT_NUMBER = TextColor.color(0x3E86FF);
    public static final TextColor FORMAT_TICK = TextColor.color(0xFF9C0A);
    ...
    public static final TextColor RESOURCE_RUBY = TextColor.color(0xE0115F);
