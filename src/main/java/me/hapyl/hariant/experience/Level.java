...
public final class Level implements Styled, ComponentLike {
    ...
    private static final Component PREFIX = Component.text("[", Colors.DARK_GRAY);
    private static final Component SUFFIX = Component.text("]", Colors.DARK_GRAY);
    ...
    private Level(int level, long experience) {
        ...
        this.style = Style.style(Colors.GRAY);
    }
